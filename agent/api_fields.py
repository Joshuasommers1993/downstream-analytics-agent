...
API_FIELDS: dict[str, dict[str, str]] = {
    ...
    # ── AUXILIARY / NON-STANDARD ENDPOINTS ───────────────────────────────────

    "api_v1_order_groups_removal_checkout_list": {
        "refund_amount": "computed",
        "cancellation_fee": "computed",
        "net_refund": "computed",
    },

    "api_v1_stripe_payment_methods_list": {
        "id": "stripe_paymentmethod",
        "object": "stripe_paymentmethod",
        "allow_redisplay": "stripe_paymentmethod",
        "created": "stripe_paymentmethod",
        "customer": "stripe_paymentmethod",
        "customer_account": "stripe_paymentmethod",
        "livemode": "stripe_paymentmethod",
        "type": "stripe_paymentmethod",
        "billing_details.address.city": "stripe_paymentmethod",
        "billing_details.address.country": "stripe_paymentmethod",
        "billing_details.address.line1": "stripe_paymentmethod",
        "billing_details.address.line2": "stripe_paymentmethod",
        "billing_details.address.postal_code": "stripe_paymentmethod",
        "billing_details.address.state": "stripe_paymentmethod",
        "billing_details.email": "stripe_paymentmethod",
        "billing_details.name": "stripe_paymentmethod",
        "billing_details.phone": "stripe_paymentmethod",
        "billing_details.tax_id": "stripe_paymentmethod",
        "card.brand": "stripe_paymentmethod",
        "card.checks.address_line1_check": "stripe_paymentmethod",
        "card.checks.address_postal_code_check": "stripe_paymentmethod",
        "card.checks.cvc_check": "stripe_paymentmethod",
        "card.country": "stripe_paymentmethod",
        "card.display_brand": "stripe_paymentmethod",
        "card.exp_month": "stripe_paymentmethod",
        "card.exp_year": "stripe_paymentmethod",
        "card.fingerprint": "stripe_paymentmethod",
        "card.funding": "stripe_paymentmethod",
        "card.generated_from": "stripe_paymentmethod",
        "card.last4": "stripe_paymentmethod",
        "card.networks.available": "stripe_paymentmethod",
        "card.networks.preferred": "stripe_paymentmethod",
        "card.regulated_status": "stripe_paymentmethod",
        "card.three_d_secure_usage.supported": "stripe_paymentmethod",
        "card.wallet": "stripe_paymentmethod",
        "metadata.payment_method_id": "stripe_paymentmethod",
        "metadata.token": "stripe_paymentmethod",
    },

    "checkout_v1_list": {
        "id": "cart_cart",
        "user_address_id": "cart_cart",
        "item_count": "cart_cart",
        "total_price": "cart_cart",
        "created_on": "cart_cart",
    },

    "matching_engine_v1_seller_product_seller_locations_by_lat_long_list": {
        "seller_location_id": "computed",
        "seller_name": "computed",
        "price": "computed",
        "delivery_fee": "computed",
    ...
    "pricing_engine_v1_seller_product_seller_location_pricing_list": {
        ...
        "rental_period": "computed",
        "fuel_surcharge": "computed",
    },

    "pricing_engine_v1_supplier_insights_list": {
        "supplier_count_nearby": "computed",
        "average_price": "computed",
        "price_range.min": "computed",
        "price_range.max": "computed",
        "competitive_index": "computed",
    },
}
