...
MCP_TOOL_CATALOG = {
    ...
    "api_v1_invoices_list": {
        ...
        "filters": "status, user_address_id, order_group_id, user_group_id, created_on__gte, created_on__lte, due_date__gte, due_date__lte",
    ...
    "api_v1_orders_list": {
        ...
        "description": (
            ...
            "Filters: status, order_group_id, user_address_id, created_on__gte, created_on__lte, start_date__gte, start_date__lte."
        ),
        "filters": "status, order_group_id, user_address_id, created_on__gte, created_on__lte, start_date__gte, start_date__lte",
        "fields": "id (str), created_on (str), updated_on (str), code (str), start_date (str), end_date (str), submitted_on (str), accepted_on (str), completed_on (str), status (str), order_type (str), schedule_window (str), sent_auto_renewal_message (bool), disposal_location (str), order_group (str), main_product (str), seller (str), account_owner (str), submitted_by (str), created_by (str), price (float)",
        "method": "GET",
    ...
    "api_v1_payouts_list": {
        ...
        "filters": "status, seller_id, created_on__gte, created_on__lte",
    ...
    "api_v1_seller_locations_list": {
        ...
        "filters": "seller_id, city, state, is_active, allow_all",
    ...
    "api_v1_user_groups_list": {
        ...
        "filters": "is_active, industry, company_size, sales_status, lifecycle_status, allow_all",
